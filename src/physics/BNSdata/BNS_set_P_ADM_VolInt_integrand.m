(* BNS_set_P_ADM_VolInt_integrand.m 
...
CFunctionFile = "BNS_set_P_ADM_VolInt_integrand.c"
...
BeginCFunction[] := Module[{},
  ...
  pr["void BNS_set_P_ADM_VolInt_integrand(tGrid *grid, int iIntegx, int iIntegy, int iIntegz)\n"];
  pr["{\n"];
