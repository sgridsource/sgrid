...
int index_Z4secondO_dTheta = Ind("Z4secondO_dTheta");
double *dTheta1 = box->v[index_Z4secondO_dTheta + 0];
double *dTheta2 = box->v[index_Z4secondO_dTheta + 1];
double *dTheta3 = box->v[index_Z4secondO_dTheta + 2];
