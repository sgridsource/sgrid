...
GlobalVars[] := Module[{},
  ...
  pr["extern double (*Coordinates_AnsorgNS_sigmap)(tBox *box, int ind, double B, double phi);\n"];
  pr["extern double (*Coordinates_AnsorgNS_dsigmap_dB)(tBox *box, int ind, double B, double phi);\n"];
  pr["extern double (*Coordinates_AnsorgNS_dsigmap_dphi)(tBox *box, int ind, double B, double phi);\n"];
