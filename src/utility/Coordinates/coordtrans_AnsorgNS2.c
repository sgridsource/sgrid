...
/* coord transforms */
XRphi[1] = (1. - A)*(-(B*ReCpOf1phi) + ReCpOfBphi) + B*Cos((1. - A)*ArgCpOf1phi + A*PIq);
XRphi[2] = (1. - A)*(-(B*ImCpOf1phi) + ImCpOfBphi) + B*Sin((1. - A)*ArgCpOf1phi + A*PIq);
XRphi[3] = phi;

/* 1st derivs */
dXRphi[1][1] = B*ReCpOf1phi - 1.*ReCpOfBphi + B*(ArgCpOf1phi - 1.*PIq)*Sin(ArgCpOf1phi - 1.*A*ArgCpOf1phi + A*PIq);
dXRphi[1][2] = -1.*(-1. + A)*(d1ReCpOfBphi - 1.*ReCpOf1phi) + Cos(ArgCpOf1phi - 1.*A*ArgCpOf1phi + A*PIq);
dXRphi[1][3] = d2ReCpOfBphi - 1.*A*d2ReCpOfBphi;
dXRphi[2][1] = B*ImCpOf1phi - 1.*ImCpOfBphi + B*(-1.*ArgCpOf1phi + PIq)*Cos(ArgCpOf1phi - 1.*A*ArgCpOf1phi + A*PIq);
dXRphi[2][2] = -1.*(-1. + A)*(d1ImCpOfBphi - 1.*ImCpOf1phi) + Sin(ArgCpOf1phi - 1.*A*ArgCpOf1phi + A*PIq);
...
/* 2nd derivs */
ddXRphi[1][1][1] = -1.*B*Cos(ArgCpOf1phi - 1.*A*ArgCpOf1phi + A*PIq)*pow2(-1.*ArgCpOf1phi + PIq);
ddXRphi[1][1][2] = -1.*d1ReCpOfBphi + ReCpOf1phi + (ArgCpOf1phi - 1.*PIq)*Sin(ArgCpOf1phi - 1.*A*ArgCpOf1phi + A*PIq);
...
ddXRphi[2][1][1] = -1.*B*pow2(-1.*ArgCpOf1phi + PIq)*Sin(ArgCpOf1phi - 1.*A*ArgCpOf1phi + A*PIq);
ddXRphi[2][1][2] = -1.*d1ImCpOfBphi + ImCpOf1phi + (-1.*ArgCpOf1phi + PIq)*Cos(ArgCpOf1phi - 1.*A*ArgCpOf1phi + A*PIq);
...
/* end of: coordtrans_AnsorgNS2.c */
/* nvars = 0, n* = 271,  n/ = 64,  n+ = 117, n = 452, O = 0 */
